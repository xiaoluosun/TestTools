...
public class CollectCheckCaseCase {
	...
	public void checkCollectCase() {
		...
		WebElement collect_content_case_btn = driver.findElement(By.id(PerCenterPageElements.COLLECT_CONTENT_CASE_BTN));
		collect_content_case_btn.click();
		
		Assertion.assertEquals(caseName, Utils.getText(driver, By.id(PerCenterPageElements.COLLECT_CONTENT_TITLE)), "收藏的病例列表第一个资源不符，请检查！");		
	}
