...
public class CollectCheckTopicCase {
	...
	public void collectTopic() {		
		...
		topicName = TerminalWebElements.case_name.getText();
	...
	public void checkCollectTopic() {
		...
		PerCenterWebElements.collect_content_topic_btn.click();
		
		Assertion.assertEquals(topicName, PerCenterWebElements.collect_content_title.getText(), "收藏的话题列表第一个资源不符，请检查！");		
	}
