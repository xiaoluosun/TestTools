...
public class Synclumpsumfee extends SimuReqBase {
  ...
  public void f() {
	  ...
	  switch(iEnv){
	  case 1:
		  	connPath = "\\data\\elt\\ips2.postevent.synclumpsumfee_55.xml";				
			//读取连接信息
			readXmlSqlConn(conn, connPath);				
			pathRelaUser = "\\data\\elt\\milefee.xml";
