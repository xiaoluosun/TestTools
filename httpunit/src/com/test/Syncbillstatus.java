  ...
  public void f() {
	  ...
	  String pathRelaUser = "";
		...
		case 1:
			...
			connPath = "\\data\\ztkd\\ips2.api.syncbillstatus_55.xml";				
			//读取连接信息
			readXmlSqlConn(conn, connPath);
			pathRelaUser = "\\data\\ztkd\\syncbillstatus_55.xml";
