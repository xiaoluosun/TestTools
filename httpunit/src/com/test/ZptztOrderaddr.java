  ...
  public void f() {
	  ...
	  case 1:
			...
			pathRelaUser = "\\data\\zptzt\\orderaddr_55.xml";
		  	...
		  	break;
	  case 2:
		  	connPath = "\\data\\zptzt\\ips2.api.orderaddr_demo.xml";				
			//读取连接信息
			readXmlSqlConn(conn, connPath);				
			pathRelaUser = "\\data\\zptzt\\orderaddr_demo.xml";
			break;
	  case 3:
		  	connPath = "\\data\\zptzt\\ips2.api.orderaddr_55.xml";				
			//读取连接信息
